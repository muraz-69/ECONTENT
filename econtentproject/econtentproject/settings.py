"""
Django settings for econtentproject project.
...
SECRET_KEY = 'django-insecure-^*^en=)q$w)lcl80rk$8-y$!lnf+3nmx**g!xu_2m(^=civ@_7'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['https://econtent.onrender.com']
...
ROOT_URLCONF = 'econtentproject.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ["/home/hunter/Desktop/ECONTENT/templates"],  
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'econtentproject.wsgi.application'
